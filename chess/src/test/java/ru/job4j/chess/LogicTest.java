...
public class LogicTest {
    ...
    @Test
    public void moveAllRight() throws FigureNotFoundException, OccupiedCellException, ImpossibleMoveException {
    ...
    public void moveCantMove() throws FigureNotFoundException, OccupiedCellException, ImpossibleMoveException {
        Logic logic = new Logic();
        logic.add(new BishopBlack(Cell.C1));
        logic.add(new BishopBlack(Cell.D2));
